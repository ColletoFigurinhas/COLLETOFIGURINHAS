                ...
                return (
                  <div key={p.id} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 6 }}>
                    <div style={{
                      ...
                      {!p.entregue && (
                        <div style={{ position: 'absolute', top: 5, right: 5, background: 'rgba(251,191,36,0.9)', borderRadius: 4, fontSize: 7, fontWeight: 900, color: '#000', padding: '2px 5px', letterSpacing: 0.5, textTransform: 'uppercase' }}>
                          Pendente
                        </div>
                      )}
                    </div>
