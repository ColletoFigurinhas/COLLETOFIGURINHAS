  ...
  return (
    ...
    <div style={{ minHeight: '100vh', background: '#080d16', color: '#fff', fontFamily: 'system-ui, sans-serif' }}>
      <header style={{
        ...
        <span style={{ fontSize: 9, fontWeight: 700, letterSpacing: 3, textTransform: 'uppercase', color: 'rgba(240,192,64,0.7)' }}>
          ⚽ Backoffice Marketing
        </span>
        <Link href="/album" style={{ marginLeft: 'auto', fontSize: 9, color: 'rgba(255,255,255,0.3)', textDecoration: 'none', letterSpacing: 1 }}>
          ← Voltar ao álbum
        </Link>
      </header>
