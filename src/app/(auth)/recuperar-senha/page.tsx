  ...
  if (etapa === 'codigo') return (
    <div style={{ width: '100%', maxWidth: 420, margin: '0 auto', padding: '0 20px' }}>
      <div style={{ textAlign: 'center', marginBottom: 32 }}>
        ...
        <div style={{ fontSize: 9, letterSpacing: 4, textTransform: 'uppercase', color: 'rgba(var(--brand-light-rgb),0.6)', marginBottom: 6 }}>
      ...
      {codigoDebug && (
        <div style={{ background: 'rgba(var(--brand-light-rgb),0.08)', border: '1px solid rgba(var(--brand-light-rgb),0.25)', borderRadius: 12, padding: 16, marginBottom: 20, textAlign: 'center' }}>
          <div style={{ fontSize: 9, color: 'rgba(var(--brand-light-rgb),0.6)', letterSpacing: 2, textTransform: 'uppercase', marginBottom: 8 }}>
            Código (modo desenvolvimento)
          </div>
          <div style={{ fontSize: 36, fontWeight: 900, letterSpacing: 10, color: 'var(--color-gold)' }}>
            {codigoDebug}
          </div>
        </div>
      )}

      <div style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(var(--brand-light-rgb),0.15)', borderRadius: 16, padding: '32px 28px' }}>
  ...
  return (
    <div style={{ width: '100%', maxWidth: 400, margin: '0 auto', padding: '0 20px' }}>
      <div style={{ textAlign: 'center', marginBottom: 36 }}>
        <div style={{ fontSize: 9, letterSpacing: 4, textTransform: 'uppercase', color: 'rgba(var(--brand-light-rgb),0.6)', marginBottom: 6 }}>Recuperar senha</div>
        <div style={{ fontSize: 14, fontWeight: 700, color: 'rgba(255,255,255,0.7)' }}>Informe sua matrícula</div>
      </div>
      <div style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(var(--brand-light-rgb),0.15)', borderRadius: 16, padding: '36px 32px' }}>
